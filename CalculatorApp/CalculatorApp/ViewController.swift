...
extension ViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        case .none:
            hundleFirstNumberSelected(number: number)
            
        case .plus, .minus, .multiplication, .division:
            hundleSecondNumberSelected(number: number)
        }
    }
    private func hundleFirstNumberSelected(number: String) {
        switch number {
        case "0"..."9":
            firstNumber += number
    ...
    private func hundleSecondNumberSelected(number: String) {
        switch number {
        case "0"..."9":
            secondNumber += number
